...
const pokemonSpeciesInfoUrl = baseApiUrl + "pokemon-species/"
const pokemonInfoUrl = baseApiUrl + "pokemon/"
...
func (client *Client) CallPokemonSpeciesInfo(name string) (PokemonSpeciesInfo, error) {
	pageUrl := pokemonSpeciesInfoUrl + name
	data, err := CallAPI[PokemonSpeciesInfo](client, pageUrl)
	if err != nil {
		return PokemonSpeciesInfo{}, err
	}
	return data, nil
